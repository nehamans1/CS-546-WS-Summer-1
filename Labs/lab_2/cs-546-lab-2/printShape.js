...
module.exports = {
    ...
    //Error checking for arguments validity
        if ((arguments.length != 1) || (typeof(lines)!="number") || lines<=0){
            throw 'Please pass only one parameter that is an integer greater than zero to the function';
        }   
...
//Function for printing squares
    ...
    //Error checking for arguments validity
        if ((arguments.length != 1) || (typeof(lines)!="number") || lines<=1){
            throw 'Please pass only one parameter that is an integer greater than one to the function';
        }   
...
//Function for printing rhombus
    rhombus: function (lines) {
        ...
        if ((arguments.length != 1) || (typeof(lines)!="number") || lines<=1 || (lines%2!=0)){
            throw 'Please pass only one parameter that is an even integer greater than one to the function';
        }
